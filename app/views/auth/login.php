...
<head>
    ...
    <!-- Bootstrap Icons CDN -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.x/font/bootstrap-icons.css">
...
<body>
    ...
    <div class="login-card p-0 mx-3">
        ...
        <div class="p-4 pt-3">
            ...
            <form action="index.php?page=auth&action=login" method="POST" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="username" name="username" placeholder="Masukkan username" style="border-radius: 0 12px 12px 0;" required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control border-start-0" id="password" name="password" placeholder="Masukkan password" style="border-radius: 0 12px 12px 0;" required>
                    </div>
                </div>
                ...
                <div class="text-center mt-2">
                    <p class="small text-secondary mb-1">Belum memiliki akun admin?</p>
                    <a href="index.php?page=auth&action=register" class="register-link small">Daftar Akun Baru <i class="bi bi-arrow-right"></i></a>
                </div>
        </div>
    </div>
